...
/**
 * Tests for {@link MavenResolverManagedDependenciesResolver}.
 *
 * @author Andy Wilkinson
 */
class MavenResolverManagedDependenciesResolverTests {

	private ManagedDependenciesResolver resolver;

	@BeforeEach
	public void createResolver(@TempDir File temp) {
		this.resolver = ManagedDependenciesResolver.withCache(temp);
	}
